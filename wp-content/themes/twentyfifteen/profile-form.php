...
<div class="login profile" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form id="your-profile" action="<?php $template->the_action_url( 'profile' ); ?>" method="post">
		...
		<tr>
			<th><label for="gender"><?php _e( 'Gender' ); ?> <span class="description"><?php _e( '(required)' ); ?></span></label></th>
			<td>
				<select name="gender" id="gender">
					
					<option value="male"<?php esc_attr($profileuser->gender) == 'male' ? ' selected="selected"' : '';?>><?php _e( 'Male' ); ?></option>
					<option value="female"<?php esc_attr($profileuser->gender == 'female' ? ' selected="selected"' : '';?>><?php _e( 'Female' ); ?></option>
					<option value="other"<?php esc_attr($profileuser->gender) == 'other' ? ' selected="selected"' : '';?>><?php _e( 'Other' ); ?></option>
				</select>
			</td>
		</tr>
